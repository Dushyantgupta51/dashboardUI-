...
void main() async {
  ...
  setupLocator();
  BottomSheetViewModal().setupBottomSheetUi();
...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      theme: HomeViewModel.isDarkModeOn
          ? MyTheme().activeDarkTheme(context)
          : MyTheme().activeLightTheme(context),
  ...
  Widget HomeView() {
    return Scaffold(
        appBar: AppBar(
            leading: IconButton(
                onPressed: () {
                  BottomSheetViewModal().showCustomBottomSheet();
                },
        ...
        body: Padding(
            ...
            child: Column(children: [
              ...
              const Divider(
                  thickness: 1, color: Color.fromARGB(12, 0, 0, 0)),
              Expanded(
                        ...
                        Container(
                            ...
                            child: Column(children: [
                              ...
                              Row(children: [
                                ...
                                const Text("6630 4459 8392 0440 435",
                                    style: TextStyle(
                                        // color: Colors.black54,
                                        fontSize: 12,
                                        fontWeight: FontWeight.bold)),
  ...
  header(Icon headerIcon, String header) {
    return Row(children: [
      headerIcon,
      const SizedBox(width: 10),
      Text(header,
  ...
  details(Icon leadingIcon, String details) {
    return Row(children: [
      leadingIcon,
      const SizedBox(width: 10),
      Text(details,
